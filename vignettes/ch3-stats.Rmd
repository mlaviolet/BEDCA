...
The following code replicates Figure 3.22. For now, we'll focus on interpreting the resulting graph.
...
The following code produces a black-and-white version of the same graph.
