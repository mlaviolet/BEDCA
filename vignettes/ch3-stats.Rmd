...
A run chart is a scatterplot where the horizontal variable represents time. Run charts are usually drawn as points with connecting lines. In the following example, the aspect ratio is changed to the "golden ratio" for aesthetics.
