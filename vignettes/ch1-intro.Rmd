...
chapter. For clarity, functions outside base R are called with the double colon operator; that is, as package_name::function_name(). Functions can also be called by loading their libraries, as below.
