...
Now we find some numerical summaries. First find the mean distortion for each treatment.
...
We'll resolve the issue by removing the missing value (since we don't know it's really missing anyway).
...
We see that the runout for the hung gears exceeds that for the laid gears by 5.3 $\times$ 0.0001 inches. Now let's make a comparative dotplot.
