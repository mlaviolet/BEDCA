...
Most of Section 4.2 discusses as set of data on the operation of a plant for the oxidation of ammonia to nitric acid. The version used by the authors appears in Table 4.8 (p. 150) and in this package as `table4_08`. Variable included are
...
$$\sum_{i=1}^{n}(y_i-\hat{y})^2$$ For the simple linear regression model predicting $y$ from $x$, the coefficients are
