...
#'
#' @note Data also used in Chapter 6, Exercise 1
#'
#' @examples
#' data(table3_06)
#' str(table3_06)
...
#'
#' @note Data reused in Section 6.5, Exercise 1
#'
#' @examples
#' data(table3_20)
#' str(table3_20)
...
#' \url{https://www.iastatedigitalpress.com/plugins/books/127/}, p. 77
#'
#' @note Data reused in Section 6.5, Exercise 2
#'
#' @examples
#' data(ch3_sec1_prob3)
#' str(ch3_sec1_prob3)
...
#'
#' @note Data also used in Section 3.3, Exercises 1 and 3; Section 6.3, Exercise 2
#'
#' @examples
#' data(ch3_sec2_prob1)
#' str(ch3_sec2_prob1)
...
#'
#' @note Data used in Section 6.1, Exercise 2
#'
#' @examples
#' data(ch3_eoc_prob03)
#' str(ch3_eoc_prob03)
...
#'
#' @note Data repeated in Section 4.2, Exercise 1; Section 9.2, Exercise 1
#'
#' @examples
#' data(ch4_sec1_prob3)
#' str(ch4_sec1_prob3)
...
#'
#' @note Data also used in Section 9.1, Exercise 2; Chapter 9, Exercise 4(b)
#'
#' @examples
#' data(ch4_eoc_prob01)
#' str(ch4_eoc_prob01)
...
#'
#' @note Data reused in Section 9.2, Exercise 1
#'
#' @examples
#' data(ch4_eoc_prob02)
#' str(ch4_eoc_prob02)
...
#' \url{https://www.iastatedigita5press.com/plugins/books/127/}, p. 204
#'
#' @note Data also used in Chapter 9, Exercise 1
#'
#' @examples
#' data(ch4_eoc_prob03)
#' str(ch4_eoc_prob03)
...
#'
#' @note Data reused in Chapter 8, Exercise 1
#'
#' @examples
#' data(ch4_eoc_prob04)
#' str(ch4_eoc_prob04)
...
#' \url{https://www.iastatedigita5press.com/plugins/books/127/}, p. 205
#'
#' @note Data reused in Chapter 8, Exercise 2
#'
#' @examples
#' data(ch4_eoc_prob05)
#' str(ch4_eoc_prob05)
...
#' \url{https://www.iastatedigitalpress.com/plugins/books/127/}, p. 211
#'
#' @note Data also used in Chapter 9, Exercise 6
#'
#' @examples
#' data(ch4_eoc_prob16)
#' str(ch4_eoc_prob16)
...
#'
#' @note Data also used in Chapter 4, Exercise 19; Chapter 9, Exercise 5
#'
#' @examples
#' data(ch4_eoc_prob18)
#' str(ch4_eoc_prob18)
...
#'
#' @note Data also used in Chapter 9, Exercise 8
#'
#' @examples
#' data(ch4_eoc_prob21)
#' str(ch4_eoc_prob21)
...
#'
#' @note Data also used in Chapter 9, Exercise 9
#'
#' @examples
#' data(ch4_eoc_prob23)
#' str(ch4_eoc_prob23)
...
#' \url{https://www.iastatedigita5press.com/plugins/books/127/}, p. 215
#'
#' @note Data also used in Chapter 9, Exercise 10
#'
#' @examples
#' data(ch4_eoc_prob24)
#' str(ch4_eoc_prob24)
...
#'
#' @note Data also used in Chapter 9, Exercise 12
#'
#' @examples
#' data(ch4_eoc_prob25)
#' str(ch4_eoc_prob25)
...
#' \url{https://www.iastatedigita5press.com/plugins/books/127/}, p. 216
#'
#' @note Data also used in Chapter 9, Exercise 13
#'
#' @examples
#' data(ch4_eoc_prob26)
#' str(ch4_eoc_prob26)
...
#'
#' @note Data also used in Chapter 9, Exercise 14
#'
#' @examples
#' data(ch4_eoc_prob27)
#' str(ch4_eoc_prob27)
...
#'
#' @note Data also appears in Chapter 9, Exercise 11
#'
#' @examples
#' data(ch4_eoc_prob28)
#' str(ch4_eoc_prob28)
...
#'
#' @note Data reused in Section 6.6, Exercise 2
#'
#' @examples
#' data(table6_07)
#' str(table6_07)
...
#' @name ch6_sec3_prob04
#' @docType data
#' @title Section 6.3, Exercise 4
#' @usage data(ch6_sec3_prob04)
#' @keywords datasets
#'
#' @format A data frame with 6 rows and 2 variableS.
#'  \describe{
...
#'
#' @source Vardeman SB & Jobe MJ (2023) \emph{Basic Engineering Data Collection and Analysis}
#' \url{https://www.iastatedigita5press.com/plugins/books/127/}, p. 385
#'
#' @note Data used in Section 6.4, Exercise 1
#'
#' @examples
...
#' @name ch7_eoc_prob16
#' @docType data
#' @title Chapter 7, Exercise 16
#' @usage data(ch7_eoc_prob16)
#' @keywords datasets
#'
#' @format A data frame with 25 rows and 4 variables.
#'  \describe{
#'   \item{SampleD1}{ID for sample taken on Day 1}
#'   \item{NonconD1}{Number of nonconforming in sample from Day 1}
#'   \item{SampleD2}{ID for sample taken on Day 2}
#'   \item{NonconD2}{Number of nonconforming in sample from Day 2}
#'   }
#'
#' @source Vardeman SB & Jobe MJ (2023) \emph{Basic Engineering Data Collection and Analysis}
#' \url{https://www.iastatedigitalpress.com/plugins/books/127/}, p. 540
...
#'
#' @note Data also used in Chapter 9, Exercise 4c
#'
#' @examples
#' data(ch9_sec3_prob1)
#' str(ch9_sec3_prob1)
...
#'
#' @note Data also used in Chapter 9, Exercise 4d
#'
#' @examples
#' data(ch9_eoc_prob03)
#' str(ch9_eoc_prob03)
